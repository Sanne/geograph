...
1. Install TorqueBox v2.0.0.beta2 (download from http://torquebox.org/release/org/torquebox/torquebox-dist/2.0.0.beta2/torquebox-dist-2.0.0.beta2-bin.zip and follow these instructions http://torquebox.org/documentation/current/installation.html)
...
7. Open the browser at http://localhost:8080, signup and you will see the Geograph map.